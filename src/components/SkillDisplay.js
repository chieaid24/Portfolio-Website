...
export default function SkillDisplay({ fileName, project = "", displayName = "", card = false }) {
  ...
  ${
    card ? 'py-1 text-[14px] opacity-90 group-hover/pc:opacity-100 hover:translate-y-[-1px] duration-200 bg-custom-orange' : 'translate-y-[2px] py-0.5 text-[16px] bg-custom-red'
  }`;
